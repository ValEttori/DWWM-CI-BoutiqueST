...
<p>Produit bloqué :
<?php echo ($produits->pro_bloque == 1 ? 'checked' : '') ?>
...
<input type="button" value="Supprimer" class="btn btn-danger b_middle" onclick="window.location.href='<?= site_url('welcome/delete/'.$produits->pro_id); ?>'">
