...
<img src="<?= base_url('assets/Img/bannF.bmp'); ?>" class="img-responsive" style="margin: 0 auto; box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);">  
</div>
...
<div class="justify-content-center">
     <img src="<?= base_url('assets/Img/femme/'); ?><?= $row->pro_id?>.<?= $row->pro_photo ?>" id="photo" alt="<?= $row->pro_libelle ?>">
